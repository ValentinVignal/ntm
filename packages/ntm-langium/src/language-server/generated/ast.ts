...
export type NtmLangiumAstType = 'Greeting' | 'Model' | 'Person';

export class NtmLangiumAstReflection implements AstReflection {
...
export const reflection = new NtmLangiumAstReflection();
